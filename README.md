...
El programa puede ejecutar siete tipos de instrucciones diferentes: LOAD carga el acumulador el valor que hay guardado en una dirección de memoria; ADD suma al valor que hay almacenado en una dirección; SUB resta ese número; MUL multiplica; DIV divide (y si el divisor es cero, el programa muestra un mensaje de error y no se detiene); STORE guarda en una dirección de memoria el valor que está; y HALT detiene la ejecución.
